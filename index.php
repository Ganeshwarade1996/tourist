	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">
		 <div class="col-md-4 about-grids">
			 ...
			 <p>Rajasthan is one of the most popular tourist destinations in India, for both domestic and international tourists. Rajasthan attracts tourists for its historical forts, palaces, art and culture. </p>
			 <p>Every third foreign tourist visiting India also travels to Rajasthan as it is part of the Golden Triangle for tourists visiting India.</p>
		 </div>
		 ...
		 <div class="col-md-4 about-grids">
			 ...
			 <p>Vacation is a time to relax in safe surroundings.For emergency aid of any kind. </p>
   ...
   <div class="top-tours-head text-center">
	     ...
	     <div id="portfoliolist">
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/Amer fort.jpg" style="width:520px;height:254px;" class="img-responsive" alt=""/></a>
							</div>
					</div>
					<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/hawa-mahal1.jpg" style="width:520px;height:254px;" class="img-responsive" alt=""/></a>
                             </div>
					</div>
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/Chittorgarh-Fort-Chittorgarh – Birthplace of Maharana Pratap.jpg" style="width:520px;height:254px;" class="img-responsive" alt=""/></a>
					...
					<div class="portfolio icon mix_all" data-cat="icon" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/Gulab Bagh and Zoo.jpg" style="width:520px;height:254px;" class="img-responsive" alt=""/></a>
					...
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/Chandra-Mahal2.jpg"  style="width:520px;height:254px;" class="img-responsive" alt=""/></a>
					...
					<div class="portfolio fun mix_all" data-cat="fun" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/chandra mahal3.jpg" style="width:520px;height:254px;" class="img-responsive" alt=""/></a>
				  ...
				  <div class="portfolio fun mix_all" data-cat="fun" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
							<img src="images/Amer-Fort3.jpg"  style="width:520px;height:254px;" class="img-responsive" alt=""/></a>
				  ...
				  <div class="portfolio icon mix_all" data-cat="fun" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/Gajner-Palace-Bikaner.jpg" style="width:520px;height:254px;" class="img-responsive" alt=""/></a>
...
<div class="tour-guides section" id="section-4" >
	  <div class="tour-guides-head text-center">
		  ...
		  <div class="container">
				<p>Book your Rajasthan Patrika Newspaper Classified advertisement instantly online at lowest rates. Rajasthan Patrika classifieds availing exciting offers & rates.</p>
		  </div>
	  </div>
	  <div class="container">
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">John Don Enterprises</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 7030582781&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;8788314942</h5>
